...
async def start_bot(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await response(update, 'começou', False)
...
def main():
    ...
    app.add_handler(MessageHandler(filters.Regex(r"^\d{5}$"), get_id))
